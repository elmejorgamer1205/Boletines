...
public class MiEntradaSalida {
    ...
    public static int solicitarEnteroEnRango(String mensaje, int limiteInferior, int limiteSuperior) throws MiEntradaSalidaException{
        // Variable que almacenará el entero introducido por teclado.
        int integer = 0;
        // Variable que almacenará un booleano que indicará si se le debe volver a pedir el dato al usuario.
        boolean flag = true;
    ...
    public static LocalDate fecha(String mensaje) throws MiEntradaSalidaException {
        ...
        try {
            ...
            throw new MiEntradaSalidaException("Error: debes poner una fecha real");
        }
    }
