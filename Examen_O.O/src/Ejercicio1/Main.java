        ...
        while (peliculeando) {
            ...
            switch (opcion) {
                ...
                case 3:
                    ...
                    try {
                        System.out.println(biblioteca.buscarPeliculaEtiqueta(etiqueta));
                ...
                case 4:
                    ...
                    try {
                        System.out.println(biblioteca.buscarPeliculaTitulo(titulo));
                    } catch (BibliotecaException e) {
                        System.out.println(e.getMessage());
                    }
                    System.out.println();
                ...
                case 5:
                    ...
                    try {
                        System.out.println(biblioteca.buscarPeliculaPresupuestoMax(presupuestoMax));
                    } catch (BibliotecaException e) {
                        System.out.println(e.getMessage());
                    }
                    System.out.println();
